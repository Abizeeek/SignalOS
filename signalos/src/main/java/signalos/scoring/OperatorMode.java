...
public class OperatorMode implements ModeConfig {
    @Override public ExecutionMode getMode() { return ExecutionMode.OPERATOR; }
    ...
    @Override public boolean appliesMaintainConsistencyBonus() { return true; }
    @Override public double getPisWeight() { return 1.5; }
