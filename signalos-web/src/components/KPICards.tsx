...
import { Activity, Target, Zap, Brain, Clock, Coffee, AlertTriangle } from 'lucide-react';
...
export function KPICards() {
  ...
  const metrics = [
    ...
    { name: 'Attention Residue', value: kpis.attentionResidue, decimals: 0, icon: Coffee, color: 'text-amber-400', bg: 'bg-amber-500/10', border: 'border-amber-500/20' },
