      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-8 z-40 w-80 glass-panel rounded-3xl overflow-hidden shadow-2xl flex flex-col border-indigo-500/20 bg-slate-900/90 backdrop-blur-xl"
          >
            ...
            <div className="flex-1 p-4 space-y-4 max-h-80 overflow-y-auto custom-scrollbar">
              {messages.map((msg, i) => (
